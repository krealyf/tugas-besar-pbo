...
public class MahasiswaGUI extends javax.swing.JFrame {
    ...
    String[] header = {"NIM", "Nama", "Tanggal Lahir"};
    ...
    public MahasiswaGUI() {
        ...
        disableButton();
        listMahasiswa = Display.importingFile1();
    ...
    private void buildTable() {
        ...
        for (int i = 0; i<listMahasiswa.size(); i++) {
            Object[] obj = {
                ...
                listMahasiswa.get(i).getTanggal()
            };
            dtm.addRow(obj);
        }
    }
    ...
    private boolean checkDuplicate(String event, int nim) {
        ...
        if (event.equals("update")) {
            ...
            return isDuplicate && (Integer.parseInt(n) != nim);
        }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            ...
            if (nama.equals("") || !validateDate || checkDuplicate("add", NIM)) {
                JOptionPane.showMessageDialog(this, "Inputkan data yang valid!",
                        "Error", JOptionPane.ERROR_MESSAGE);  
            } else {
                Mahasiswa mahasiswa = new Mahasiswa(NIM, nama, tanggal);
                listMahasiswa.add(mahasiswa);
                Update.add(mahasiswa);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        nimField.setText(dtm.getValueAt(row, 0).toString());
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        try {
            ...
            if (nama.equals("") || !validateDate || checkDuplicate("update", NIM)) {
                JOptionPane.showMessageDialog(this, "Inputkan data yang valid!",
                        "Error", JOptionPane.ERROR_MESSAGE);  
            } else {
                listMahasiswa.get(row).setNIM(NIM);
                listMahasiswa.get(row).setNama(nama);
                listMahasiswa.get(row).setTanggal(tanggal);
                Update.replaceMahasiswa(NIM, nama, tanggal, row);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
         if (listMahasiswa.size() > 0 && row >= 0) {
            ...
            JOptionPane.showMessageDialog(this, "Pilih data pada tabel untuk dihapus.",
                    "Error", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    private void restoreButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restoreButtonActionPerformed
        JFileChooser fileChooser = new JFileChooser(Path.path + "\\data\\mahasiswa");
        int respone = fileChooser.showOpenDialog(null);
        
        if (respone == JFileChooser.APPROVE_OPTION) {
            File f = fileChooser.getSelectedFile();
            FileMod.restoreFileMahasiswa(f.getPath());
            listMahasiswa = Display.importingFile1();
            buildTable();
